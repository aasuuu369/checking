  ...
  <script src="assets/js/main.js"></script>
	...
	<div style="margin: auto;
	  ...
	  padding: 10px;">
		...
		<form action = "getTime" method = "POST" style="width: 100%;">
			<fieldset>
			<legend></legend>	<br><br>	
				<label for = "start">From: </label>
					<select id="from" name ="start" required>
				...
				<label for = "start">To: </label>
					<select id="to" name= "end" required>
						<option value="null"></option>
						<option value="Ampara">Ampara</option>
						<option value="Colombo">Colombo</option>
						<option value="Galle">Galle</option>
				...
				<label for = "noOfSeats">No. Of Seats:</label>
					<select id="to" name = "noofSeats" required>
				...
				<label for="date">Booking Date:</label>
		            <input type="date" name="bookingday" required>
		    <br><br>
		        ...
		        <input type="checkbox" id="checkbox" class="inputstyle" onclick="enableButton()"> Agree to Terms and Conditions<br><br>
	              	...
	              	<input type="submit" value="Check For Buses" id="submitBtn" class="btn" style = "background-color: #ba2f43; /* Green */
																							  border: none;
																							  color: white;
																							  padding: 15px 32px;
																							  text-align: center;
