	 ...
	 <div class="alll">
	    <div class="all">
	        <div class="main">
	            ...
	            <h1>Feedback submit Unsuccessfully !!! </h1>
	            <h4>Please Try Again</h4>
	
	            <br>
	            <div class="img">
	            <img src="CSS/uns.gif" alt="" srcset="" class="gif1">
	        </div>
	        </div>
	        ...
	        <div class="butall">
	            <div class="allb">
	                ...
	                <div class="but"><!--BOUTTON -->
	                    <a href="Home.html"> 
	                    <button type="submit" class="button" id="submit" placeholder="">
	                    <b> Go to Home Page</b>
	                    </button> 
	                    </a>
	                </div><!--END BOUTTON -->
	                <br>
	                <div class="but"><!--BOUTTON -->
	                    <a href="customer_feedback.jsp"> 
	                    <button type="submit" class="button" id="submit" placeholder="">
	                    <b> Go to Feedback Page</b>
	                    </button> 
	                    </a>
	                </div><!--END BOUTTON -->
